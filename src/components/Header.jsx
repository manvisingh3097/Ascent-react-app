            ...
            <div className=" navbar navbar-expand-lg navbar-light bg-light container " id="navbarSupportedContent">
                <ul className="navbar-nav mr-auto navbar container">
                    ...
                    <li className="nav-item">
                        <Link className="nav-link" to="/cat/ABOUT">
                           ABOUT
                        </Link>
                    </li>
                    <li className="nav-item">
                        <Link className="nav-link" to="/cat/FACILITIES">
                        FACILITIES
                        </Link>
                    </li>
                    <li className="nav-item">
                        <Link className="nav-link" to="/cat/BLOG">
                            BLOG
                        </Link>
                    </li>
                    <li className="nav-item">
                        <Link className="nav-link" to="/cat/CONTACT">
                            CONTACT
                        </Link>
                    </li>
                </ul>
